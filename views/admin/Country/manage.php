            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="<?= site_url();?>/Country/add" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add New Country Flag</a></h3>
                    </div>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1" href="<?= site_url()?>/Country/edit/<?= $data['id'];?>">Edit</a>
                                                    </li>
                                                    <li>
                                                        <a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/Country/delete/<?= $data['id'];?>">Delete
                                                        </a>
                                                    </li>
