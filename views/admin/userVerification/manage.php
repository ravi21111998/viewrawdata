                        ...
                        <form method="post" id="getPdf">
                        	<div class = "col-md-12" style="margin-left:60px;margin-top:10px;margin-bottom:20px">
                                	...
                                	<div class="main-data-single-field">
                                    	<span style="font-weight: bold;">Search Host</span>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/UserVerification/ViewHost/<?= $data['id'];?>/1">View</a>
                                                    </li>

                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            onclick="return confirm('Are you sure you want to delete this?');"
                                                            href="<?= site_url()?>/UserVerification/DeleteHost/<?= $data['id'];?>/1">Delete</a>
                                                    </li>
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/UserVerification/ViewHost/<?= $data['id'];?>/2">View</a>
                                                    </li>

                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            onclick="return confirm('Are you sure you want to delete this?');"
                                                            href="<?= site_url()?>/UserVerification/DeleteHost/<?= $data['id'];?>/2">Delete</a>
                                                    </li>
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/UserVerification/ViewHost/<?= $data['id'];?>/3">View</a>
                                                    </li>

                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            onclick="return confirm('Are you sure you want to delete this?');"
                                                            href="<?= site_url()?>/UserVerification/DeleteHost/<?= $data['id'];?>/3">Delete</a>
                                                    </li>
...
$(document).ready(function() {
    $("#search").click(function() {
        ...
        $.ajax({
            type: "post",
            url: "<?= site_url()?>/user/getHostResult",
            data: {
                s: start,
                e: end,
                p: name
            ...
            success: function(data) {
                if (data == '') {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        //     '</td><td>' + comment.name + '</td><td>' + comment.email +
                        ...
                        //     '</a></li></ul></li></ul></td></tr>';
                            ...
                            html += '<tr><td>' + (i+1) + '</td><td>' + comment.username + '</td><td>' + comment.name + '</td><td>' + comment.email +
                            '</td><td><span class="label label-warning">' + comment.phone + '</span></td><td>' + comment.agencyId + '</td><td><span class="label label-success">' + comment.host_status +
                            '</span></td><td><ul class="admin-action btn btn-default" style="background-color: #f4f4f4;color: #fff !important;"><li class="dropdown"><a class="dropdown-toggle" style="color: black;" data-toggle="dropdown" href="#" aria-expanded="false">' + "Action " + '<span class="caret"></span></a><ul class="dropdown-menu dropdown-menu-right"><li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo  site_url()?>/UserVerification/ViewHost/'+comment.id+'/'+comment.get+'">View</a></li><li><a role="menuitem" tabindex="-1" onclick="return confirm(&quot;Once you deleted this account, the user (' + comment.username + ') will no longer be able to log in to the site or apps. This action cannot be undone.&quot;);" href="<?= site_url()?>/UserVerification/deleteHost/'+comment.id+'/'+comment.get+'">Delete</a></li>  </ul></li></ul></td></tr>';
                    }
