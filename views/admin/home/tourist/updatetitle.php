<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/Home/ttitle">Manage Title</a></li>
						...
						<div class="box-body">
							<div class="form-group">
							 ...
							 <div class="form-group">
				                  ...
				                  <img src="<?php echo base_url().$details['image'];?>" style="width:80px;margin-top: 10px;margin-bottom: 10px;"><br>
