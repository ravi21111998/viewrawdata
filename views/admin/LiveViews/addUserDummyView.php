<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/LiveViews/dummyUserView">Manage User Dummy View</a></li>
					...
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" value="<?= set_value('viewCount');?>" name="viewCount" placeholder="view count">
