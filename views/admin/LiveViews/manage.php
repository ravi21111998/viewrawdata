	...
	<section class="content">
		<div class="row">
          ...
          <div class="box-header">
            <h3 class="box-title"><a href="<?php echo site_url()?>/LiveViews/addDummyView" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Dummy View</a></h3>
          </div>
					<!-- /.box-header -->
					<div class="box-body">
										...
										<ul class="admin-action btn btn-default" style="background-color: #f4f4f4;color: #fff !important;">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/LiveViews/deleteDummyView/<?php echo  $data['id'];?>/<?php echo  $data['userId'];?>">Delete
											            </a>
													</li>
