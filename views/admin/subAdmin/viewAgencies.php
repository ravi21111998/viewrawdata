                        ...
                        <form method="post" id="getPdf">
                        	<div class = "col-md-12" style="margin-left:60px;margin-top:10px;margin-bottom:20px">
                                	...
                                	<div class="main-data-single-field">
                                    	<span style="font-weight: bold;">Search Agency</span>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/subAdmin/manageHost/<?= $data['id'];?>">Manage Hosts</a>
                                                    </li>
                                                    
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/subAdmin/manageAgency/<?= $data['id'];?>">Manage Agency</a>
                                                    </li>


                                                    <li role="presentation" class="divider"></li>
                                                    <li>
                                                        <!-- <a role="menuitem" tabindex="-1" href="<?= site_url()?>/subAdmin/rejectAgency/<?= $data['id'];?>">Reject
                                                            Agency
                                                        </a> -->
                                                        <?php if($data['status'] == '1'){?>
                                                            <a role="menuitem" tabindex="-1" data-toggle="modal" data-target="#exampleModal<?= $data['id'];?>">Reject
                                                            Agency
                                                        </a>
                                                        <?php } else{?>
                                                            <a role="menuitem" tabindex="-1" onclick="reApprove('<?= $data['agencyCode'] ?>')">Re-Approve Agency</a>
                                                        <?php }?>
                                                    </li>
                                                    <!-- <li role="presentation">
                                ...
                                <div class="modal fade" id="exampleModal<?= $data['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Reject Agency</h5>
...
$(document).ready(function() {
    $("#search").click(function() {
        ...
        $.ajax({
            type: "post",
            url: "<?= site_url()?>/SubAdmin/getAgencyResult",
            data: {
                s: start,
                e: end,
                p: name
