                        ...
                        <div role="tabpanel" style="background-color: #fff;" class="tab-pane active" id="track">
                            <ul style="padding: 0;margin: 0;">
                                <div class="col-md-6">
                                    ...
                                    <li>
                                        <a href="#">Post Likes</a>
                                        <span><?php echo $view['likeCount']?></span>
                                    </li>
                                    <li>
                                        <a href="#">Comments</a>
                                        <span><?php echo $view['commentCount']?></span>
                                    </li>
                                     <li>
                                        <a href="#">Post Created</a>
                                        <span><?php echo $view['created']?></span>
                                    </li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <li>
                                        <a href="#">Status</a>
                                        <?php if($view['postStatus'] == '0'){?>
                                        <span class="label label-info">Pending</span>
                                        <?php } elseif($view['postStatus'] == '1'){?>
                                    ...
                                    <?php 
                                    if($view['postStatus'] == 0)
                                    {?>
 
                                    <li style="border-bottom: none; margin-top: 50px;"><a href="#" style="color: #f39b12;font-size: 15px;">Product Request Status</a> </li>
                                        <li style="border-bottom: none;padding-top: 0px;">
                                            <select name="status" class="col-md-12 form-control" id="userIdBanUnbanData"
                                                ...
                                                <option value="0"
                                                    <?php if($view['postStatus'] == 0){ echo "selected"; } ?>>Pending
                                                </option>
                                                <option value="1"
                                                    <?php if($view['postStatus'] == 1){ echo "selected"; } ?>>Approve
                                                </option>
                                                <option value="2"
                                                    <?php if($view['postStatus'] == 2){ echo "selected"; } ?>>Reject
                                                </option>
...
function userIdBanUnban(id) {
    ...
    $.ajax({
        type: 'post',
        url: "<?php echo site_url();?>/Admin/postStatusUpdate",
        data: {
            userId: userId,
            status: status
        },
        success: function(result) {
            if (result == 1) {
                swal({
                    title: "Good job!",
                    text: "Post Approve/Reject status updated successfully!",
                    icon: "success",
                });
            } else {
                swal({
