                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody id="ts">
                                ...
                                <tr>
                                    ...
                                    <!--<td><?php  echo $data['commentCount'];?></td>-->
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-success">Video Post</span>
                                        <?php } else{?>
                                        <span class="label label-danger">-</span>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if($data['postStatus'] == '0'){ ?>
                                        <span class="label label-info">Pending</span>
                                        <?php  } elseif($data['postStatus'] == '1'){ ?>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/Admin/ViewProductRequest/<?= $data['id'];?>/0">View</a>
                                                    </li>
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/Admin/ViewProductRequest/<?= $data['id'];?>/1">View</a>
                                                    </li>
                                                    ...
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/Admin/ViewProductRequest/<?= $data['id'];?>/2">View</a>
                                                    </li>
