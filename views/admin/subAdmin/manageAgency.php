...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/subAdmin/viewAgency">Manage Agency</a></li>
							...
							<div role="tabpanel" style="background-color: #fff;" class="tab-pane active" id="track">
								 <ul style="padding: 0;margin: 0;">
									<div class="col-md-6">
										<li>
											<a href="#">AgencyName</a>
											<span><?php echo $details['agencyName']?></span>
										</li>
										<li>
											<a href="#">Username</a>
										...
										<li>
											<a href="#">Agency UniqueId</a>
											<span><?php  echo $details['agencyCode'];?></span>
										</li>
										
										
										<li>
											<a  href="#">Agency Link</a>
											<span><a class = "btn btn-warning" style="color:white !important" href="https://xrdsimulators.tech/wow_project/index.php/AgencyPanel?id=<?=$details['agencyCode']?>&&pass=<?=$details['viewPassword']?>">Link</a></span>
											
										
											
											<span><a class = "btn btn-warning" style="color:white !important" href="https://xrdsimulators.tech/wow_project/index.php/subAdmin/sendEmail/<?=$details['id']?>">Shear Link</a></span>
										</li>
