											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/admin/viewOneDayBannedUser/<?= $data['id'];?>">View</a>
													</li>
													<!--<li role="presentation">-->
