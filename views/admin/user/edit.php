				...
				<form role="form" method="post" id="specialitiesForm" enctype="multipart/form-data">
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label>Bio*</label>
								<input type="text" class="form-control" value="<?php echo $details['bio']?>" name="email" placeholder="Email">
								<div class="form-error1"><?= form_error('email');?></div>
							</div>
							<div class="form-group">
								<label>Profile Image*</label>
								<input type="file" class="form-control" name="image" placeholder="Mobile">
