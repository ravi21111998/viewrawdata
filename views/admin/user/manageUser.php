                ...
                <a href="javascript:void(0)" id="getexcel">   <i class="fa fa-file-excel-o" style=" color:green;" aria-hidden="true"></i></a>
                  ...
                  <td>
                    ...
                    <?php } ?>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/user/viewUser/<?= $data['id'];?>">View</a>
													</li>
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/user/edit/<?= $data['id'];?>">Edit</a>
													</li>
													<li><a role="menuitem" tabindex="-1" onclick="return confirm(&quot;Once you've deleted 	this account, the user (<?php  echo $data['username'];?>) will no longer be able to log in to the site or apps. This action cannot be undone.&quot;);" href="<?= site_url()?>/user/delete/<?= $data['id'];?>">Delete
											            </a>
													</li>
                          ...
                          <li role="presentation"><a role="menuitem" tabindex="-1" href="<?= site_url()?>/user/sendGiftHistory/<?= $data['id'];?>">Send Gift History</a></li>
