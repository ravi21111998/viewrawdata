                  ...
                  <select name="status" class="col-md-12 form-control" id="deviceBlockUnBlockData" style="border: 2px solid #f39b127a;" onchange="deviceBlockUnBlock(<?php  echo $details['id'];?>)">
                          ...
                          <option value="1" <?php if($deviceBlockStatus == 1){ echo "selected"; } ?> >Ban Id</option>
									...
									<div class="col-md-6">
										...
										<!-- himanshu -->
										<li style="border-bottom: none;">
											<a href="#" style="color: #f39b12;font-size: 15px;">Agency Join Status</a>
										</li>
										
										<li style="border-bottom: none;padding-top: 0px;">
											<input name="status" class="col-md-12 form-control" value="<?=(!!$agency) ? 'Agency Joined' : 'No Agency Joined' ?>" style="border: 2px solid #f39b127a;" />
												
										</li>
										<?php
										if(!!$agency) {?>
										<li style="border-bottom: none; padding-top: 38px;" >
											<a href="#" style="color: #f39b12;font-size: 15px;">Joined Agency Code</a>
										</li>
										
										<li style="border-bottom: none;padding-top: 0px;">
											<input name="status" class="col-md-12 form-control" value="<?=$agency['agencyId']?>" style="border: 2px solid #f39b127a;" />
