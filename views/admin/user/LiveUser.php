...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/User/manageUser/<?php echo $mainId;?>"> View User</a></li>
                    ...
                    <ul class="admin-action btn btn-default" style="background-color: #f4f4f4;color: #fff !important;">
                          ...
                          <?php if($data['status'] == 'live'){?>
  													<li role="presentation">
  														<a role="menuitem" tabindex="-1" href="<?php echo site_url()?>/User/archivedLiveUser/<?php echo $data['id']?>">Archived</a>
  													</li>
                          <?php } else{?>
                            <li role="presentation">
  														<a role="menuitem" tabindex="-1" href="javascript:void(0)" style="cursor: progress;">Archived</a>
  													</li>
                          <?php }?>
												</ul>
											</li>
