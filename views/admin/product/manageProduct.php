		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Product/addProduct" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Product</a></h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php $i = 1; foreach($details as $data){ ?>
								<tr>
									...
									<td><img style="width:60px;" src="<?= base_url().$data['image']?>"/></td>
										...
										<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
                                                        ...
                                                        <script>
                                                            $("#online_status_<?php echo $data['id']; ?>").click(function(){
                                                                ...
                                                                $.ajax({
                                                                type: "POST",
                                                                url: "<?php echo base_url(); ?>index.php/product/product_set_status",
                                                                data:'id=<?php echo $data['id']; ?>',              
                                                                success: function(data){
                                                                    if(data==1){
                                                                        alert('Product is active now');
                                                                    }else{
                                                                        alert('Product is inactive now');
                                                                    }
                                                                }
                                                                });
                                                              });
									...
									<td>
										<a href="<?= site_url()?>/Product/editProduct/<?= $data['id'];?>">
