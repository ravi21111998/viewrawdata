<div class="content-wrapper">
    ...
    <?php if($this->session->flashdata('success')){ ?><div class="form-error">
            <script>
            swal("Good job!", "Your data successfully inserted!", "success");
            </script>
        </div><?php unset($_SESSION['success']); }else if($this->session->flashdata('error')) { ?>
            <div class="form-error">
            <script>
            swal("Error","Please provide parameter", "error");
            </script>
        </div>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url();?>/Admin/Images">View Images</a></li>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input accept="images/*" type="file" class="form-control" name="images" id="file-ip-1"
                                    onchange="showPreview1(event)">

                                <img id="file-ip-1-preview" name="pre" src="#" alt="your images" height="70" width="70"
                                    style="display: none;">

                                <div class="form-error1"><?= form_error('images');?></div>
