                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody id="ts">
                                ...
                                <tr>
                                    <td><?= $i;?></td>
                                    <td><img src="<?php echo base_url().$data['theme']?>" style="width:80px"></td>
                                        ...
                                        <ul class="admin-action btn btn-default"
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li>
														<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/Admin/deleteThemes/<?= $data['id'];?>">Delete
											            </a>
													</li>
