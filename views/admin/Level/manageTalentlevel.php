            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="<?= site_url();?>/Level/addTalentLevel" style="font-size: 14px;"
                                class="btn btn-block btn-success btn-xs">Add New</a></h3>
                    </div>
                    <!-- 
                    <div class="main-data">
                        <div class="row">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/Level/editTalentLevel/<?= $data['id'];?>">Edit</a>
                                                    </li>
                                                    <li>
                                                        <a role="menuitem" tabindex="-1"
                                                            onclick="return confirm('Are you sure you want to delete?');"
                                                            href="<?= site_url()?>/Level/deleteTalent/<?= $data['id'];?>">Delete
                                                        </a>
                                                    </li>
                                                    <!-- <li role="presentation" class="divider"></li>
                                                    <li role="presentation">
                                                        <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/Level/status/<?= $data['id'];?>">
            ...
            success: function(data) {
                if (data == '') {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr><td>' + (i + 1) + '</td><td>' + comment.title +
                            '</td><td>' + img + '</td><td>' + comment.primeAccount +
                            '</td><td>' + comment.nonPrimeAccount +
