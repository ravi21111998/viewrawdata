...
<div class="login-box">
  <div class="login-logo">
   <a href=""><img style="width: 50%;" src="<?php echo base_url();?><?= $logo ?>"></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url();?>/admin/login" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" style="background:#3caea3; border-color: #0000ff;color: white;" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
