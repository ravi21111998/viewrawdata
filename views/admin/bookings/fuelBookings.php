		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Fueling in progress</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php $i = 1; foreach($details as $data){ ?>
								<tr>
									...
									<td><span class="new badge green" data-badge-caption="red" style="background-color:brown;">Fueling In Progress</span></td>
									<td>
