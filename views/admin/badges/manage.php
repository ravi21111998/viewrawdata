		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Badges/add" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Badges</a></h3>
					</div>
                <!-- 
                	<div class="main-data">
					         	<div class="row">
										...
										<ul class="admin-action btn btn-default" style="background-color: #f4f4f4;color: #fff !important;">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/Badges/delete/<?php echo  $data['id'];?>">Delete </a>
													</li>
												</ul>
											</li>
										</ul>
