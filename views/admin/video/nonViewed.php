		...
		<div class="row">
		   ...
		   <!-- /.box -->
				<div class="box">
                   ...
                   <div class="main-data">
   					          	<div class="row">
                           <form method="post" action="<?= site_url()."/videos/getNonViewed";?>" id="getPdf">
...
<script>
   $("#perPage").change(function(){
     ...
     $.ajax({
        type:'post',
        url:"<?php echo site_url() ?>/Videos/nonViewed",
        data: {perPage:perPage},
        success: function (result){
           // alert(result);
           // location.reload();
           window.location.assign("<?php echo site_url() ?>/Videos/nonViewed");
        }
     });
   });
</script>
