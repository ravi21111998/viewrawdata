	...
	<section class="content">
		<div class="row">
		   ...
		   <!-- /.box -->
                ...
                <div class="main-data">
					          	<div class="row">
                        <form method="post" action="<?= site_url()."/videos/getRejected";?>" id="getPdf">
                            ...
                            <div class="col-md-2">
                                   ...
                                   <select name="perPage" id = "perPage">
                                      <option <?php if($per_page == 10){ echo "selected";} ?>>10</option>
                                      <option <?php if($per_page == 25){ echo "selected";} ?> >25</option>
                                      <option <?php if($per_page == 50){ echo "selected";} ?> >50</option>
                                      <option <?php if($per_page == 100){ echo "selected";} ?> >100</option>
                                   </select>
                                </div>
                            </div>
								           <div class="col-md-3">
            ...
            <button type="submit" class="btn btn-primary" name="approve" id="approveVideo">Approve</button>
                ...
                <th>Reject Time</th>
                  ...
                  <td><?php echo $data['adminComment']; ?></td>
                  <td><?php
...
<script>
   $("#perPage").change(function(){
     ...
     $.ajax({
        type:'post',
        url:"<?php echo site_url() ?>/Videos/rejected",
        data: {perPage:perPage},
        success: function (result){
           // alert(result);
           // location.reload();
           window.open("<?php echo site_url() ?>/Videos/rejected");
        }
     });
   });
</script>
