					...
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" value="<?php echo $details['price']?>" name="price" placeholder="Price">
								<div class="form-error1"><?= form_error('price');?></div>
							</div>
							<div class="form-group">
								<label>Gems Count  *</label>
								<input type="text" class="form-control" value="<?php echo $details['count']?>" name="count" placeholder="Count">
