						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php $i = 1; foreach($details as $data){ ?>
								<tr>
									...
									<td>0</td>
									<td>
										<?php if($data['series'] == 'Yes'){?>
											<span class="label label-success"><?php  echo $data['series'];?></span>
										<?php } else{?>
											<span class="label label-warning"><?php  echo $data['series'];?></span>
										<?php }?>
									</td>
									<td>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Category/view/<?= $data['id'];?>">View</a>
													</li>
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Category/edit/<?= $data['id'];?>">Edit</a>
													</li>
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm(&quot;Once you've deleted 	this account, the category (<?php  echo $data['title'];?>) will no longer be able to log in to the site or apps. This action cannot be undone.&quot;);" href="<?= site_url()?>/Category/delete/<?= $data['id'];?>">Delete
											            </a>
													</li>
