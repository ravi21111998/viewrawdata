                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Coin</th>
                                    <th>Date/Time</th>
                                    <?php if($admin['role'] == 0) { ?><th>Action</th> <?php } ?>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $i;?></td>
                                    <td><img src="<?php echo $data['image'];?>" style="width: 50px;height: 50px;"></td>
                                    <td><?php  echo $data['username'];?></td>
                                    <!-- <td><?php   if(!empty($data['adminName'])){ echo $data['adminName'];}else{ echo "Super Admin"; }?></td> -->
                                    <td><?php   if(!empty($data['adminName'])){ echo $data['adminName'];}else{ echo "Master Admin"; }?>
                                    </td>
                                    ...
                                    <?php if($admin['role'] == 0) { ?><td><button class="btn btn-danger"
                                            onclick="undoCoins(<?php echo $data['id']; ?>)">Undo</button></td><?php } ?>
                                </tr>
                                <?php $i++; } ?>
                            </tbody>
                        </table>
