                            ...
                            <tbody id="ts">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-success"><?php  echo $data['coins'];?></span>
                                        <?php } else{?>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li role="presentation">
                                                        <form method="POST"
                                                            action="<?= site_url()?>/subAdmin/singleCoinAgencyHistory">
                                                            <input name="id" type="text" value="<?= $data['id'];?>"
                                                                hidden>
                                                            <input type="submit" value="View History" name="submit">
                                                        </form>
                                                        <!-- <a role="menuitem" tabindex="-1"
                                                            href="<?= site_url()?>/subAdmin/singleCoinAgencyHistory/<?= $data['id'];?>">View
                                                            History</a> -->
                                                    </li>
