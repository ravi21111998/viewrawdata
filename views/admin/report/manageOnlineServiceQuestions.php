		   ...
		   <!-- /.box -->
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/Report/addQuestion" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Question</a></h3>
						<h3 class="box-title"><a href="<?= site_url();?>/Report/manageOnlineServiceAnswers" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Manage Answers</a></h3>
					</div>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/Report/editQuestion/<?= $data['id'];?>">Edit</a>
													</li>
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/Report/deleteQuestion/<?= $data['id'];?>">Delete
											            </a>
													</li>   	             	
												</ul>
											</li>
