...
<body>
    ...
    // $stmt = $conn->prepare("SELECT name FROM admin WHERE email = 'omkar@xrdigitech.com'");
    //   $this->db->select('name'); // Specify that only the 'name' field should be selected
    //     $this->db->from('admin');  // Specify the table name
    //     $this->db->where('id', $adminId); // Add the condition for the email
    //     $query = $this->db->get(); // Execute the query
        
    //     $stmt = $query->row_array(); // Get the result as an associative array
