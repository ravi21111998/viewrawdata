...
.TalentDiamond p::after {
    content: '<?php if (!empty($TalentDiamond['TalentDiamond'])) {echo $TalentDiamond['TalentDiamond'];} else {echo 0;} ?>';
    height: 2px;
    width: 15px;
    margin-top: -5px;
    margin-left: 157px;
