...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <!--<a href="<?= site_url();?>/AgencyPanel/dashboard" class="logo">-->
             <a href="<?= site_url();?>/AgencyPanel/mainDash" class="logo">
          ...
          <span class="label label-warning"><?= $newOrder;?></span>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="header"><a href="<?php echo site_url()?>/Bookings">You have total <?= $newOrders?> Orders.</a></li>
                        ...
                        <li class="dropdown user user-menu me-2">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?php echo base_url();?>assets/dist/img/user2-160x160.jpg" class="user-image"
                                    alt="User Image">
                                <?php }?>
                                <span class="hidden-xs"><?php echo $admin['agencyName']; ?></span>
                            </a>
                            <ul class="dropdown-menu me-3">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <small><?= $admin['agencyName']; ?></small>
                                    </p>
                                </li>
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo site_url()?>/agencyPanel/edit_profile"
                                            class="btn btn-default btn-flat">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?php echo site_url();?>/agencyPanel/logout"
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <div class="user-panel" style="padding-bottom: 20px !important;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="<?php if($active == 'dashboard'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/AgencyPanel/mainDash"><i
                                class="fa fa-dashboard"></i>Dashboard</a></li>

                    <li class="header">Account Management</li>
                    
                    <li class="<?php if($active == 'adminPortal'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/AgencyPanel/manageHost"><i class="fa fa-users"></i>Agency
                            Host</a></li> 
                    ...
                    <!--<li class="<?php if($active == 'hostList'){ echo "active"; }?>"><a-->
                    <!--        href="#"><i class="fa fa-users"></i>Host List</a></li>-->
                            
                            <!--<li class="<?php if($active == 'hostList'){ echo "active"; }?>"><a href="<?php echo site_url()?>/Talent/manage"><i class="fa fa-users"></i>Host List</a></li>-->
                            
                            <li class="<?php if($active == 'hostList'){ echo "active"; }?>"><a href="<?php echo site_url()?>/AgencyPanel/get_host_target_data"><i class="fa fa-users"></i>Host Record</a></li>

                    <!-- 
                    <li class="<?php if($active == 'agencyReport'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/AgencyPanel/report"><i class="fa fa-users"></i>Agency
                            Report</a></li> -->
        ...
        <li class="<?php if($active == 'addUser' || $active == 'user' || $active == 'verifyUser' || $active == 'userreport' || $active == 'userMessage' || $active == 'liveuser' || $active == 'hotlist'){ echo "active"; }?> treeview">
         ...
         <li class="<?php if($active == 'edit_profile'){ echo "active"; }?>"><a href="<?php echo site_url()?>/admin/edit_profile"><i class="fa fa-diamond"></i>Account</a></li> -->
                    ...
                    <li class="<?php if($active == 'edit_profile'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/agencyPanel/edit_profile"><i
                                class="fa fa-diamond"></i>Account</a></li>
                    <li class="<?php if($active == 'shearlinkRecord'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/agencyPanel/shearlinkRecord"><i
                                class="fa fa-share"></i>Shear Link Record</a></li>
      ...
      <ul class="treeview-menu">
        <li class="<?php if($active == 'logo'){ echo "active"; }?>"><a href="<?php echo site_url()?>/agencyPanel/logo"><i class="fa fa-circle-o"></i>Logo</a></li>
        <li class="<?php if($active == 'length'){ echo "active"; }?>"><a href="<?php echo site_url()?>/agencyPanel/length"><i class="fa fa-circle-o"></i>Description Length</a></li>
        <li class="<?php if($active == 'splash'){ echo "active"; }?>"><a href="<?php echo site_url()?>/agencyPanel/splash"><i class="fa fa-circle-o"></i>Splash Image</a></li>
      </ul>
    </li> -->
                    <li class=""><a href="<?php echo site_url()?>/AgencyPanel/logout"><i class="fa fa-sign-out"></i>Sign
                            Out</a></li>
                </ul </section>
                <!-- /.sidebar -->
        </aside>