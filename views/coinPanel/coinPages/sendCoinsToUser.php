<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="form-error">
            <script>
            swal("Error","Please enter valid UserId", "error");
            </script>
        </div>
         <?php unset($_SESSION['error']);}else if($this->session->flashdata('flashherrorrr')) { ?>
        
        <div class="form-error">
            <script>
            swal("Error","Insufficient Coin Balance", "error");
            </script>
        </div>
