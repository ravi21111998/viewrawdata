...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?= site_url();?>/CoinPanel/dashboard" class="logo">
              ...
              <li class="header"><a href="<?php echo site_url()?>/Bookings">You have total <?= $newOrders?> Orders.</a></li>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="<?php echo base_url(). $admin['image'];?>" class="user-image"
                                    alt="User Image">
                                <?php } else{ ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="<?php echo base_url(). $admin['image'];?>" class="img-circle"
                                        alt="User Image">

                                    <p>
                                        <?php echo $admin['uniqueId'];?>
                                        <!--<small><?php echo $admin['email'];?></small>-->
                                    </p>
                                </li>
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo site_url()?>/CoinPanel/edit_profile"
                                            class="btn btn-default btn-flat">Profile</a>
                                        <!-- <a href="#" class="btn btn-default btn-flat">Profile</a> -->
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?php echo site_url();?>/CoinPanel/logout"
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="<?php if($active == 'dashboard'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/CoinPanel/dashboard"><i class="fa fa-dashboard"></i>Coin
                            Agency Portal</a></li>
          ...
          <ul class="treeview-menu">
           ...
           <li class="<?php if($active == 'hotlist'){ echo "active"; }?>"><a href="<?php echo site_url()?>/User/hotListUser"><i class="fa fa-circle-o"></i>Hotlist User</a></li>
            ...
            <li class="<?php if($active == 'userreport'){ echo "active"; }?>"><a href="<?php echo site_url()?>/User/userReport"><i class="fa fa-circle-o"></i>User Report</a></li>
                    ...
                    <li
                        class="<?php if( $active == 'sendCoinHistory' || $active == 'recieveCoinHistory' || $active == 'sendCoins'){ echo "active"; }?> treeview">
                        <a href="#">
    			...
    			<li class="<?php if($active == 'ppvpayment'){ echo "active"; }?>"><a href="<?php echo site_url()?>/Payment/ppvpayment"><i class="fa fa-circle-o"></i>PPV Payments</a></li> -->
                            <li class="<?php if($active == 'sendCoins'){ echo "active"; }?>"><a
                                    href="<?php echo site_url()?>/CoinPanel/sendCoinsToUser"><i
                                        class="fa fa-circle-o"></i>Send Coins</a></li>
                            <!-- <li class="<?php if($active == 'addSubadminCoins'){ echo "active"; }?>"><a href="#"><i class="fa fa-circle-o"></i>Send Coins</a></li> -->

                            <li class="<?php if($active == 'sendCoinHistory'){ echo "active"; }?>"><a
                                    href="<?php echo site_url()?>/CoinPanel/coinaHistory"><i
                                        class="fa fa-circle-o"></i>Send Coin History</a></li>
                            <li class="<?php if($active == 'recieveCoinHistory'){ echo "active"; }?>"><a
                                    href="<?php echo site_url()?>/CoinPanel/recieveCoinHistory"><i
                    ...
                    <li class="<?php if($active == 'edit_profile'){ echo "active"; }?>"><a
                            href="<?php echo site_url()?>/CoinPanel/edit_profile"><i
...
<?php } ?> -->
                    <li class=""><a href="<?php echo site_url();?>/CoinPanel/logout"><i class="fa fa-sign-out"></i>Sign
                            Out</a></li>
                </ul>
            </section>
            <!-- /.sidebar -->
