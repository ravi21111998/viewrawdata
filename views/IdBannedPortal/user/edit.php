				...
				<form role="form" method="post" id="specialitiesForm" enctype="multipart/form-data">
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label>Purchased Coin*</label>
								<input type="text" class="form-control" value="<?php echo $details['purchasedCoin']?>" name="purchasedCoin" placeholder="Purchased Coin">
								<div class="form-error1"><?= form_error('purchasedCoin');?></div>
							</div>
							<div class="form-group">
								<label>Mobile*</label>
								<input type="text" class="form-control" value="<?php echo $details['phone']?>" name="phone" placeholder="Mobile">
