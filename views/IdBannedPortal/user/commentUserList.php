...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url();?>/User/videoList/<?php echo $mainId;?>"> Video List</a></li>
						...
						<table id="example1" class="table table-bordered table-striped">
							...
							<?php $i = 1; foreach($details as $data){ ?>
								<tr>
									...
									<td><?php  echo $data['commentCreated'];?></td>
									<td><?php  echo $data['comment'];?></td>
									<td>
										<?php if(!empty($data['image'])){?>
											<img src="<?php echo $data['image'];?>" style="width: 60px;height: 60px">
										<?php } else{ ?>
												<img src="<?php echo base_url()?>uploads/no_image_available.png" style="width: 60px;height: 60px">
										<?php } ?>
									</td>
								</tr>
							<?php $i++; } ?>
