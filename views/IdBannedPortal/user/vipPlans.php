		   ...
		   <!-- /.box -->
				<div class="box">
				    ...
				    <div class="box-header">
						<h3 class="box-title"><a href="<?= site_url();?>/User/addVipPlans" style="font-size: 14px;" class="btn btn-block btn-success btn-xs">Add Vip Plans</a></h3>
					</div>
				    <form id="getform" >
					<!-- <div class="box-header">
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="<?= site_url()?>/user/viewVipPlans/<?= $data['id'];?>">View</a>
													</li>
													<li>
														<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure you want to delete?');" href="<?= site_url()?>/user/deleteVipPlans/<?= $data['id'];?>">Delete
											            </a>
													</li>
													<!--<li role="presentation">-->
